...
public class AboutActivityy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_about_activityy);
    ...
    private void loadActivity() {
        ...
        feedbackImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                feedbackIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"lalitkoli11121998@gmail.com"});
        ...
        sourceCodeOnGitHubCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                view.performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY);
                String githubLink = "https://github.com/lalitkoli11121998" +"/latestupdate";
        ...
        openSourceLicensesFrameLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                view.performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY);
                String attributionsLink = "https://github.com/lalitkoli11121998";
